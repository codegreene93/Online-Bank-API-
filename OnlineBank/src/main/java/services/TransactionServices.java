...
public class TransactionServices {
	...
	Transaction tran1 = new Transaction(480, 1, 001, 10.02, "Lidl", "debit", 136);
	Transaction tran2 = new Transaction(481, 2, 002, 11.02, "Tesco", "Credit", 200);
	Transaction tran3 = new Transaction(482, 3, 003, 14.02, "transfer", "saving", 1600);
